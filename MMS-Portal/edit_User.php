...
if (!isset($_GET['id']) || UserDB::getById($_GET['id']) == null) {
...
<body>
    ...
    <div class="container" style="width: 50%; float: left">
        <h1>Update User</h1>
        <?php $user = UserDB::getById($_GET['id']); ?>
        ...
        <?php foreach ($user as $u) { ?>
            ...
            <form method="post" action="edit_User.php">
                <div class="form-group">
                    ...
                    <input class="col-lg-4" value="<?php echo $u->username; ?>" name="update_username" required><br><br>
                    <label>New Password (not required):</label><br>
                    <input type="password" class="col-lg-4" name="update_password" placeholder="Enter new password..."><br><br>
                    <label>Role:</label><br>
                    <select name="adminOrNot">
                        <option value="0" <?php if ($u->type == 0) {
                                                echo "selected";
                                            } ?>>Admin</option>
                        <option value="1" <?php if ($u->type == 1) {
                                                echo "selected";
                                            } ?>>Normal user</option>
                    </select><br><br>
                    <button type="submit" class="btn btn-success" style="background-color: #0b6623;" name="update_user">Submit</button>
                </div>
            </form>
