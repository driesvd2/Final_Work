...
include 'Database/Forms/AlterTableEffect/server.php';
...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="width: 50%; float: left; height: 80%; overflow:auto">
        ...
        <h1>Manage Effect table</h1>
        <br/>
        <h3>Add new column</h3>
        <form method="post" action="manageEffectTable.php">
            <div class="form-group">
                <input class="col-lg-4" type="text" name="AlterNewColumnEffect"><br><br>
                <button type="submit" class="btn btn-success" style="background-color: #0b6623;" name="submitAlterNewColumnEffect">Submit</button>
            </div>
        </form>   
    </div>
    
    <?php $metaColumnsEffect = EffectDB::getAllMetaColumnsOfEffect(); ?>
