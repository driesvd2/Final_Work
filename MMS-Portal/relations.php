...
if(isset($_POST['searchCauseOfCauseEffect']) && isset($_POST['causeSelectedCauseEffect'])) {
    ...
    foreach($querySearchCluster as $q){
       ...
       array_push($resultSearchCausesOfCauseEffect, CauseEffectDB::getCauseEffectWhereIdCause($q->idCause));
        
    }    
 }


if(isset($_POST['searchCauseOfCauseEffect']) && isset($_POST['effectSelectedCauseEffect'])) {
    ...
    foreach($querySearchClusterEffect as $qe){
       ...
       array_push($resultSearchEffectOfCauseEffect, CauseEffectDB::getCauseEffectWhereIdEffect($qe->idEffect));
        
        
    }      
 }

if(isset($_POST['searchCauseOfCauseEffect']) && !isset($_POST['effectSelectedCauseEffect']) && !isset($_POST['causeSelectedCauseEffect'])) {
    ...
    //var_dump($querySearchCluster->idCause);
...
if(isset($_POST['searchclusterCause']) && isset($_POST['causeSelectedCluster'])) {
    ...
    foreach($queryCauseSearchCluster as $q){
       ...
       array_push($resultSearchCausesOfCluster, ClusterDB::getCauseClusterWhereIdCause($q->idCause));
        
    }  
 }


if(isset($_POST['searchclusterCause']) && isset($_POST['effectSelectedCluster'])) {
    ...
    foreach($queryEffectSearchCluster as $q){
       ...
       array_push($resultSearchEffectsOfCluster, ClusterDB::getCauseClusterWhereIdCause($q->idEffect));
...
//    foreach($querySearchCluster as $q){
//        
//        $resultSearchCausesOfCauseEffect = CauseEffectDB::getCauseEffectWhereIdCause($q->idCause);
//        
//        
//        
//    }   
...
//    $searchCausesOfCauseEffect = CauseEffectDB::getSearchCauseOfCauseEffect($zbeub->idCause);
//        
//    var_dump($searchCausesOfCauseEffect);
////    var_dump($querySearchCluster);
////    $receivedCauseEffects = CauseEffectDB::getCauseEffectWhereIdCause(2);
////    
////    
    ...
    <br>
        ...
        <div class="container" style="overflow: auto; height: 80%; width: 50%; float: left">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="causeSelectedCluster" />
                <label class="form-check-label">Search by Cause</label><br/>
                <input class="form-check-input" type="radio" name="effectSelectedCluster"/>
                <label class="form-check-label">Search by Effect</label>
            </div>
            ...
            for($c = 0; $c < count($resultSearchCausesOfCluster); $c++){ 
                ...
                <tr>
                    <td><?php echo $c+1 ?></td>
                    <td><?php $cause = CauseDB::getById($res->Cause_idCause); echo $cause[0]->CauseName;?></td>
                    <?php
                    $arrayEffects = ClusterDB::translateStringToEffects($res->Cluster_Effects);
                    ?>
                    <td><?php
                    $stringEffects = "";
                    ...
                    <td>
                        <form method="post" action="relations.php">
                            <input type="hidden" value="<?php echo $res->idCluster?>" name="Delete_Cluster_id">
...
<!--   ------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="container" style="width: 50%; float: left;overflow: auto; height: 80%;">
        ...
        <form action="relations.php" method="post">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="causeSelectedCauseEffect" />
                <label class="form-check-label">Search by Cause</label><br/>
                <input class="form-check-input" type="radio" name="effectSelectedCauseEffect"/>
                <label class="form-check-label">Search by Effect</label>
            </div>
        ...
        <table class="table table-bordered table-hover" >
            ...
            <?php for ($e = 0; $e < count($resultSearchCausesOfCauseEffect); $e++){ 
                ...
                <tr>
                    <td><?php echo $e + 1?></td>
                    <td><?php $cause = CauseDB::getById($res->Cause_idCause); echo $cause[0]->CauseName; ?></td>
                    <td><?php $effect = EffectDB::getById($res->Effect_idEffect); echo $effect[0]->EffectName;  ?></td>
                    <td>
                        <form method="post" action="relations.php">
