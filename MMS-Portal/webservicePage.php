...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="margin-left:1%;width: 48%; float: left; height: 80%; ">
        ...
        <form method="post" action="webservicePage.php" onchange="this.form.submit()">            
            ...
            <div id="resultWebserviceSearch" class="container" style="float: left; overflow: auto; margin-top: 8px; margin-bottom: 8px"></div>
        </form>
    </div>
        ...
        <form method="post" action="webservicePage.php">
           ...
           <?php foreach($_SESSION["catchedCauseEffects"] as $deGecatcheteCauseArray) {  
               ...
               ?>
                <tr>
                    <td>
                        <?php $effect = EffectDB::getById($deGecatcheteCause->effect); echo $effect[0]->name; ?>
                    </td>
                    <td>
                        <?php $cause = CauseDB::getById($deGecatcheteCause->cause); echo $cause[0]->name; ?>
                    </td>
                </tr>
            <?php }} ?>
                 </tbody>
...
$(document).ready(function(){
	...
	function load_data(queryWebservice, columnSearchEffectWebservice)
	{
		$.ajax({
			...
			method:"post",
			data:{queryWebservice:queryWebservice, columnSearchEffectWebservice:columnSearchEffectWebservice},
