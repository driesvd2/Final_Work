...
include 'Database/Forms/AlterTableCauseEffect/server.php';
    ...
    <div class="container" style="width: 50%; float: left; height: 80%; overflow:auto">
        ...
        <form method="post" action="manageCause_EffectTable.php">
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-success" style="background-color: #0b6623;" name="submitAlterCauseEffectNewColumn">Submit</button>
            </div>
        </form>
    </div>

    <?php $metaColumnsCauseEffect = CauseEffectDB::getAllMetaColumnsOfCauseEffect(); ?>
    <div class="container" style="width: 35%; float: left; height: 80%; overflow:auto">
        <table class="table table-bordered table-hover">
            <form method="post" action="manageCause_EffectTable.php">
                ...
                <tbody>
                <?php foreach ($metaColumnsCauseEffect as $meta) { ?>
                        <tr>
                            <form method="post" action="manageCause_EffectTable.php">
                            <td>
                            ...
                            <td><button type="submit" class="btn btn-danger" style="background-color: #DA291C; position: sticky;" value="<?php echo $meta; ?>" name="deleteColumnCauseEffect"><i class="fa fa-trash" style="font-size: 20px;"></i></button></td>
                            </form>
                        </tr>
                    <?php } ?>
                </tbody>
