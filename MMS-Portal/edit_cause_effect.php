...
// OFWEL KIEZEN VOOR DIT UIT COMMENT MAAR ALS JE DIT DOET DAN KAN JE NIET MEER TERUG OP EDIT CLUSTER ALS JE EEN CAUSE WIL TOEVOEGEN VANUIT EDIT_CAUSE_EFFECT.PHP
//if (!isset($_GET['id'])) {
// 
...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="width: 50%; float: left; height: 80%;">
        ...
        <form method="post" action="edit_cause_effect.php">
            ...
            <a href="insert_Cause.php?clickedOnCauseEffectEdit=editCauseEffect" class="greenIcon"><i class="fa fa-plus-square" style="font-size: 28px;"></i></a>
            <?php } ?></h2>
    ...
    <div id="resultCauseEffectEditCause" class="container" style="float: left; overflow: auto; height: 20%; margin-top: 8px; margin-bottom: 8px"></div>
    ...
    <div id="resultCauseEffectEditEffect" class="container" style="float: left; overflow: auto; height: 20%; margin-top: 8px; margin-bottom: 8px"></div>
...
$(document).ready(function(){
	...
	function load_data(queryCauseEffectEditCause, columnSearchCauseCauseEffectEdit)
	{
		$.ajax({
			...
			method:"post",
			data:{queryCauseEffectEditCause:queryCauseEffectEditCause, columnSearchCauseCauseEffectEdit:columnSearchCauseCauseEffectEdit},
...
$(document).ready(function(){
	...
	function load_data(queryCauseEffectEditEffect, columnSearchEffectCauseEffectEdit)
	{
		$.ajax({
			...
			method:"post",
			data:{queryCauseEffectEditEffect:queryCauseEffectEditEffect, columnSearchEffectCauseEffectEdit:columnSearchEffectCauseEffectEdit},
			success:function(data)
			{
