...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="width: 50%; float: left; height: 80%;">
        ...
        <?php if (isset($_GET['idEffect'])) {
            $_SESSION["deIdVanStatusPageCauseEffect"] = $_GET['idEffect'];
        }
        ?>
    ...
    <div id="result" class="container" style="float: left; overflow: auto; height: 20%; margin-top: 8px; margin-bottom: 8px"></div>
            ...
            <h2>Effects</h2>
                ...
                <input class="form-check-input" type="radio" checked name="Effect" value="<?php echo $sessieRedirectStatusEffect[0]->idEffect ?>" id="<?php echo $sessieRedirectStatusEffect[0]->idEffect ?>">
                 <label class="form-check-label" for="<?php echo $sessieRedirectStatusEffect[0]->idEffect ?>">
                            <?php echo $sessieRedirectStatusEffect[0]->EffectName; ?>
                        </label><br/>
                </div>
             <?php } else { ?>
            ...
            <?php if(isset($_SESSION["deIdVanStatusPageCauseEffect"])) { ?>
                <button type="submit" class="btn btn-danger" name="unsetSessionsCauseEffect" style="margin-top: 8px">Cancel</button>
            <?php  } ?>
        </form>
