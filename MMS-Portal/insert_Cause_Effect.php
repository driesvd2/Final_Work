...
<body style="height: 100%;overflow:auto">
    ...
    <div class="container" style="width: 50%; float: left; height: 80%;">
        ...
        <form method="post" action="insert_Cause_Effect.php">
            ...
            <div id="result" class="container" style="float: left; overflow: auto; height: 14%; margin-top: 8px; margin-bottom: 8px"></div>
            ...
            <?php } else { ?>
                ...
                <div id="resultEffect" class="container" style="float: left; overflow: auto; height: 14%; margin-top: 8px; margin-bottom: 8px"></div>
            ...
            function load_data(queryEffect, columnSearchEffect) {
                $.ajax({
                    ...
                    data: {
                        ...
                        columnSearchEffect: columnSearchEffect
                    },
                    success: function(data) {
