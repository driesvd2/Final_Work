...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="width: 35%; float: left; height: 80%; margin-right:15%;">
        ...
        <form method="post" action="insert_Cluster.php">
            ...
            <?php } else if (isset($_SESSION["effectOnChangeName"]) && isset($_SESSION["causeOnChangeName"])) { ?>
            <div class="form-check container" style="overflow: auto; height: 65%; width: 35%; float: left;">
             <h2>Causes</h2>
            ...
            for($c = 0; $c < count($clusters); $c++){ ?>
                <tr>
                    ...
                    <td><?php $cause = CauseDB::getById($clusters[$c]->cause); echo $cause[0]->name;?></td>
                    <?php
...
$(document).ready(function(){
	...
	function load_data(queryClusterCause, columnSearchCauseCluster)
	{
		$.ajax({
			...
			method:"post",
			data:{queryClusterCause:queryClusterCause, columnSearchCauseCluster:columnSearchCauseCluster},
...
$(document).ready(function(){
	...
	function load_data(queryClusterEffect, columnSearchEffectCluster)
	{
		$.ajax({
			...
			method:"post",
			data:{queryClusterEffect:queryClusterEffect, columnSearchEffectCluster:columnSearchEffectCluster},
			success:function(data)
			{
