...
<body style="height: 100%;overflow:hidden">
    ...
    <div class="container" style="width: 50%; float: left; height: 80%;">
        ...
        <form method="post" action="edit_cluster.php" onchange="this.form.submit()">
            ...
            <a href="insert_Cause.php?clickedOnEditCluster=editCluster" class="greenIcon"><i class="fa fa-plus-square" style="font-size: 28px;"></i></a>
            <?php } ?></h2> 
            ...
            <div id="resultClusterEditCause" class="container" style="float: left; overflow: auto; height: 20%; margin-top: 8px; margin-bottom: 8px"></div>
            ...
            <div id="resultClusterEditEffect" class="container" style="float: left; overflow: auto; height: 20%; margin-top: 8px; margin-bottom: 8px"></div>
    ...
    ?>        
        ...
        <div class="form-check container" style="overflow: auto; height: 80%; width: 48%; float: left;">
...
$(document).ready(function(){
	...
	function load_data(queryClusterEditCause, columnSearchCauseClusterEdit)
	{
		$.ajax({
			...
			method:"post",
			data:{queryClusterEditCause:queryClusterEditCause, columnSearchCauseClusterEdit:columnSearchCauseClusterEdit},
...
$(document).ready(function(){
	...
	function load_data(queryClusterEditEffect, columnSearchEffectClusterEdit)
	{
		$.ajax({
			...
			method:"post",
			data:{queryClusterEditEffect:queryClusterEditEffect, columnSearchEffectClusterEdit:columnSearchEffectClusterEdit},
			success:function(data)
			{
